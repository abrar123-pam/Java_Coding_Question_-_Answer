...
import static SWIGGY.Register.stored_customer;
import static SWIGGY.Register.stored_hotel;

public class files {
    private static final String HOTEL_FILE = "C:\\Users\\Abrar Musharraf P\\IdeaProjects\\Practice\\src\\SWIGGY\\hotels.txt";

    private static final String FOOD_FILE = "C:\\Users\\Abrar Musharraf P\\IdeaProjects\\Practice\\src\\SWIGGY\\foods.txt";

    private static final String CUSTOMER_FILE = "C:\\Users\\Abrar Musharraf P\\IdeaProjects\\Practice\\src\\SWIGGY\\customer.txt";


    public static void saveCustomer(){
        try(FileWriter writer = new FileWriter(CUSTOMER_FILE)) {
            for (Customer customer : stored_customer.values()) {
    ...
    public static void loadCustomers() {
        try (BufferedReader reader = new BufferedReader(new FileReader(CUSTOMER_FILE))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                stored_customer.put(customer.getId(), customer);
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void loadHotels() {
        try (BufferedReader reader = new BufferedReader(new FileReader(HOTEL_FILE))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                stored_hotel.put(hotel.getShopName(), hotel);
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
